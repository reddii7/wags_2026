-- Home dashboard slice: latest finalized summer week + hero/stats + integer handicap
-- steps + Best 14 top 3 (with ties) + division leaders tiers 1–4 in order.
-- Edge `fetch-all-data` calls this instead of duplicating the logic in JS.
