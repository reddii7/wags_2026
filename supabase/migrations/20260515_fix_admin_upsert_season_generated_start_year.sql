-- Fix admin season upsert for generated start_year column
-- wags.seasons.start_year is GENERATED ALWAYS from start_date.
...
begin
  ...
  insert into wags.seasons (id, label, start_date, end_date, is_active)
  values (p_id, p_label, p_start_date, p_end_date, p_is_active)
  on conflict (id)
  do update set
